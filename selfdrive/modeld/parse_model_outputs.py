...
class Parser:
  ...
  # @atoms ALC-015 — Scene Confidence Score: meta outputs extracted here feed confidence classification
  ...
  # @atoms ALC-011 — Path Prediction: extracts driving path/trajectory from policy model output
